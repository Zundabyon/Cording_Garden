    ...
    public function run(): void
    {
        $characters = [
            ...
            [
                ...
                'subject' => 'laravel',
                'description' => '生徒会長を務める完璧なお姉さま。Laravelフレームワークを使いこなし、どんな課題も優雅にこなす。穂香先輩の良き相棒。',
                'is_unlocked' => true,
                'sort_order' => 2,
            ],
            [
            ...
            [
                ...
                'name_kana' => 'たかみね せいじ',
                'gender' => 'male',
                'personality' => '城島翔の兄。メガネクイッの完璧主義者。弟を溺愛。型安全を極めた知性派。',
                'subject' => 'typescript',
                'description' => '城島翔の兄。常にメガネをかけ、論理的で完璧主義。弟のことを溺愛していて、弟の友達には目を光らせている。TypeScriptの型システムを愛している。',
                'is_unlocked' => false,
                'sort_order' => 6,
            ],
            [
